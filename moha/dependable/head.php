...
$index = 'index.php';
$contact = 'contact_me.php';
$about = 'about_me.php';
$portfolio = 'my_portfolio.php';
...
<head>
    ...
    <title>Codeman - Personal Portfolio & CV</title>
    <meta name="description" content="Codeman - Personal Portfolio & CV">
                    ...
                    <div class="menu-container">
                            ...
                            <a class="navbar-brand me-0" href="index.php">
                                <svg width="24" height="24" version="1.1" id="Layer_1"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" xml:space="preserve">
                                        ...
                                        <path fill="#000000"
                                            d="M6.671,37.759l2.812,2.812l8.436-8.436l-8.436-8.436l-2.812,2.812l5.624,5.624L6.671,37.759z"
                                            class="logo-icon" />
                                        <path fill="#000000" d="M26.489,36.111h-7.954v3.977h7.954V36.111z"
                                            class="logo-icon" />
                                        <path fill-rule="evenodd" clip-rule="evenodd" fill="#000000" d="M4.116,0.346c-2.196,0-3.977,2.112-3.977,4.717V42.8c0,2.605,1.78,4.717,3.977,4.717h39.768c2.196,0,3.977-2.112,3.977-4.717V5.063c0-2.605-1.78-4.717-3.977-4.717H4.116z M43.884,5.063H4.116V42.8h39.768V5.063z" class="logo-icon" />
                                    
                                </svg>

                                <span>Code<span class="primary">man</span></span>
                            </a>
                        </div>
                        <div class="navbar-main d-flex flex-grow-1">
                            ...
                            <ul class="navbar-info mx-auto">
                                <li class="nav-item">
                                    <a class="nav-link  <?php if($page_name==$index){echo "active";} ?>" aria-current="page" href="index.php">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?php if($page_name==$about){echo "active";} ?>" href="about_me.php">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?php if($page_name==$portfolio){echo "active";} ?>" href="my_portfolio.php">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?php if($page_name==$contact){echo "active";} ?>" href="contact_me.php">
                                        <svg class="nav-icon" viewBox="0 0 18 17" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="header-right-info d-flex align-items-center">
                                ...
                                <a href="contact_me.php" class="lets-talk-btn">
                                    Let's Talk

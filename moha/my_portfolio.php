                ...
                <div class="card-body portfolio-card">
                  <div class="top-info">
                    <div class="text">
                      ...
                      <p>I'm here to help if you're searching for a designer to bring your idea to life or a
                    ...
                    <div class="row g-4 parent-container">
                      <div class="col-lg-12">
                        <div class="portfolio-item">
                          <div class="image">
                            <img src="assets/img/projects/project-3.png" alt="project-1" class="img-fluid w-100">
                          ...
                          <div class="text">
                            <div class="info">
                              <a href="#" class="title">Food Delivery App</a>
                              <p class="subtitle">Flutter & Dart | UI UX Design</p>
                            </div>
                      ...
                      <div class="col-lg-12">
                        <div class="portfolio-item">
                          <div class="image">
                            <img src="assets/img/projects/project-4.png" alt="project-2" class="img-fluid w-100">
                          ...
                          <div class="text">
                            <div class="info">
                              <a href="#" class="title">e-Furniture Store</a>
                      ...
                      <div class="col-lg-12">
                        <div class="portfolio-item">
                          <div class="image">
                            <img src="assets/img/projects/project-5.png" alt="project-3" class="img-fluid w-100">
                            <a href="assets/img/projects/project-5.png"
                              class="gallery-popup full-image-preview parent-container">
                              <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none"
                                stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
                                <path d="M10 4.167v11.666M4.167 10h11.666"></path>
                          ...
                          <div class="text">
                            <div class="info">
                              <a href="#" class="title">Tasks and Calender app</a>
